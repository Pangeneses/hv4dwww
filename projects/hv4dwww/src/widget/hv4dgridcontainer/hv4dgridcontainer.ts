...
@Component({
  ...
  imports: [],
  templateUrl: './hv4dgridcontainer.html',
  styles: `./hv4dgridcontainer.css`,
  standalone: true
})
...
@Component({
  selector: 'hv4dgridcontainer',
  imports: [],
  templateUrl: './hv4dgridcontainer.html',
  styles: `./hv4dgridcontainer.css`,
  standalone: true
})
export class hv4dgridcontainer implements OnInit, AfterContentInit {
